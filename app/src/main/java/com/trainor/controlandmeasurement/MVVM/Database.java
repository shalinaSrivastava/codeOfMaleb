...
@androidx.room.Database(entities = {LoginEntity.class, AssignmentEntity.class, LetterEntity.class, ImageEntity.class, FolderEntity.class}, version = 7, exportSchema = false)
